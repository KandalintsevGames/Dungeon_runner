...
def init_enemy(enemy_size,extra,x,y,welle):
    ...
    for i in range(x):
        ...
        enemy_rect_dictionary[i]= [enemy.get_rect(center = liste_positionen[r.randint(0,3)]),100+(welle*5),100,enemy_img,-10-(welle*5),100+(welle * 5),100]
